    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Doubloons version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  doubloonsd [options]                     " + "\n" +
                  "  doubloonsd [options] <command> [params]  " + _("Send command to -server or doubloonsd") + "\n" +
                  "  doubloonsd [options] help                " + _("List commands") + "\n" +
                  "  doubloonsd [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: doubloonsd.pid)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Doubloons is probably already running."), strDataDir.c_str()));
